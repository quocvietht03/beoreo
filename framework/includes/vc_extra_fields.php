 ...
 */
function beoreo_taxonomy_settings_field($settings, $value) {
...
beoreo_add_extra_parame('bt_taxonomy', 'beoreo_taxonomy_settings_field');
...
function beoreo_hidden_settings_field($settings, $value){
...
beoreo_add_extra_parame('tb_hidden', 'beoreo_hidden_settings_field');
