...
vc_map ( array (
		...
		"params" => array (
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Image size', 'beoreo' ),
						'param_name' => 'img_size',
						'value' => 'full',
						'group' => __('Template', 'beoreo'),
						'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size.', 'beoreo' ),
					),
					array(
						"type" => "textfield",
						"class" => "",
