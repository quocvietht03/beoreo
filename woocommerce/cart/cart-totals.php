...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<!--h2><?php _e( 'Cart Totals', 'beoreo' ); ?></h2-->

	<div class="row">
		<div class="col-md-6">
			<div class="shipping-wrap">
				<h4><?php _e( 'Estimate Shipping Tax', 'beoreo' ); ?></h4>
				<p><?php _e( 'Choose Your Destination And Get Shiping & Tax Estimate.', 'beoreo' ); ?></p>
		...
		<div class="col-md-5">
			<div class="grand-total">
				<h4><?php _e( 'Cart Totals', 'beoreo' ); ?></h4>
				<div class="total-wrap">
					<ul class="shop_table shop_table_responsive">

						<li class="cart-subtotal">
							<span class="title"><?php _e( 'Subtotal', 'beoreo' ); ?></span>
							<span data-title="<?php _e( 'Subtotal', 'beoreo' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></span>
						</li>
						...
						<?php elseif ( WC()->cart->needs_shipping() ) : ?>
							...
							<li class="shipping">
								<span class="title"><?php _e( 'Shipping', 'beoreo' ); ?></span>
								<span data-title="<?php _e( 'Shipping', 'beoreo' ); ?>"><?php woocommerce_shipping_calculator(); ?></span>
							</li>
						...
						<?php if ( wc_tax_enabled() && 'excl' === WC()->cart->tax_display_cart ) :
							...
							$estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
									? sprintf( ' <small>(' . __( 'estimated for %s', 'beoreo' ) . ')</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
									: '';
						...
						<li class="order-total">
							<span class="title"><?php _e( 'Total', 'beoreo' ); ?></span>
							<span data-title="<?php _e( 'Total', 'beoreo' ); ?>"><?php wc_cart_totals_order_total_html(); ?></span>
						</li>
