...
<div class="shop_table woocommerce-checkout-review-order-table">
	<h3 class="order-review-heading"><?php _e( 'Your order', 'beoreo' ); ?></h3>
	<ul>
		<li class="header">
			<span class="col-left product-name"><?php _e( 'Product', 'beoreo' ); ?></span>
			<span class="col-right product-total"><?php _e( 'Total', 'beoreo' ); ?></span>
		</li>
		<?php
		...
		<li class="cart-subtotal">
			<span class="col-left"><?php _e( 'Subtotal', 'beoreo' ); ?></span>
		...
		<li class="order-total">
			<span class="col-left"><?php _e( 'Total', 'beoreo' ); ?></span>
